...
### This application is to manage space with respect to Buildings, Rooms, and Occupants. Each building will have multiple rooms, each room can have mutliple allocated occupants
## APIs : 
